...
\begin{figure}[ht]
  \centering
  \subfigure[True labels]{\includegraphics[scale=0.25]{figures/true_labels.pdf}}
  \subfigure[Predictions]{\includegraphics[scale=0.25]{figures/preds.pdf}}
\caption{Half moons with Gaussian noise of 0.15 standard deviation. (a) represents the true labels of each moon, and (b) represents the MLP predictions. Accuracy is 99.3\% on this example.}
\label{fig:pred_and_true}
\end{figure}
