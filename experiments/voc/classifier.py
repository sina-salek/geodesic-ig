...
from torchvision.models import resnet18, ResNet18_Weights, convnext_base, ConvNeXt_Base_Weights, efficientnet_v2_l, EfficientNet_V2_L_Weights
...
class VocClassifier(nn.Module):
    def __init__(self, backbone_name="resnet18"):
        ...
        if backbone_name == "resnet18":
            ...
            self.backbone = shufflenet_v2_x0_5(weights=ShuffleNet_V2_X0_5_Weights.DEFAULT)
            num_features = self.backbone.fc.in_features
            self.backbone.fc = nn.Linear(num_features, 20)
